<template>
    <div class="media-preview-card"  :class="{'small':width>=760}">
        <router-link :to="{name: (data.manga)? 'Manga' : 'Anime', params:{slug: i.url.split('/')[2]}}" class="cover" v-lazy:background-image="url + i.image.preview">
        ...
        <div class="content">
            <div class="info-header">
                <div v-text="data.relation_russian"></div>
            </div>
